...
from scenarios.sakura_harbour.epilogue.dialogues import arc_complete_dialogue
from utils import general_utils


class SakuraHarbourArcCompleteScreen(RichLog):
    can_focus = True
    ...
    async def render_arc_complete(self, color: str) -> None:
        ...
        dialogues = arc_complete_dialogue.SAKURA_HARBOUR_ARC_COMPLETE_DIALOGUES.replace(
    ...
    async def on_key(self, event: events.Key) -> None:
        if event.key == "enter":
            ...
            general_utils.update_progress(
                active_challenge_id="25",
                story_intro_act=global_constants.STORY_ACT_YUMOTO_SPRINGS,
            ...
            await container.mount(YumotoSpringsIntroScreen())
